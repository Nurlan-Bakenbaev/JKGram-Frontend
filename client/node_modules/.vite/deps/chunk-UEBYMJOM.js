import {
  ...
  ownerWindow_default
} from "./chunk-WDXTUWUC.js";
import {
  ListContext_default
} from "./chunk-BFU6EKMN.js";
import {
  useEnhancedEffect_default as useEnhancedEffect_default2
} from "./chunk-RSJCTIRI.js";
import {
  Transition_default
} from "./chunk-6SA2BECZ.js";
import {
  HTMLElementType,
  alpha,
  chainPropTypes,
...
var MenuList = React4.forwardRef(function MenuList2(props, ref) {
  const {
    // private
  ...
  const textCriteriaRef = React4.useRef({
    keys: [],
    repeating: true,
  ...
  React4.useImperativeHandle(actions, () => ({
  ...
  React4.Children.forEach(children, (child, index2) => {
  ...
  const items = React4.Children.map(children, (child, index2) => {
    if (index2 === activeItemIndex) {
      ...
      return React4.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var DropdownContext = React9.createContext(null);
...
function useControllableReducer(parameters) {
  ...
  const [nextState, dispatch] = React10.useReducer(reducerWithControlledState, initialState);
...
var FormControlContext = React14.createContext(void 0);
if (true) {
...
var FormControl = React15.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
...
var Input = React18.forwardRef(function Input2(props, forwardedRef) {
...
var ListContext = React21.createContext(null);
if (true) {
...
var CompoundComponentContext = React23.createContext(null);
...
var Modal = React36.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
  ...
  return (0, import_jsx_runtime21.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime22.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime21.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime21.jsx)(FocusTrap, {
        ...
        open,
        children: React36.cloneElement(children, childProps)
      })]
    }))
  });
});
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime31.jsx)(React48.Fragment, {
...
var Select = React48.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React48.Fragment, {
...
var Slider = React50.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime33.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime33.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime34.jsxs)(React50.Fragment, {
...
var TextareaAutosize = React68.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React68.Fragment, {
...
var Grow = React71.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React71.cloneElement(children, _extends({
        style: _extends({
          opacity: 0,
...
var Fade = React72.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime51.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React72.cloneElement(children, _extends({
        style: _extends({
          opacity: 0,
          visibility: state === "exited" && !inProp ? "hidden" : void 0
...
var Backdrop = React73.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime52.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
true ? Backdrop.propTypes = {
   ...
   * @default false
   */
  invisible: import_prop_types33.default.bool,
  /**
   * If `true`, the component is shown.
   */
...
var _excluded32 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"];
...
var Modal3 = React74.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime53.jsx)(Portal, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime54.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime53.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime53.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React74.cloneElement(children, childProps)
      })]
    }))
  });
});
...
var _excluded33 = ["className", "component", "elevation", "square", "variant"];
...
var Paper = React75.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
  ...
  return (0, import_jsx_runtime55.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var Popover = React76.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded34), other = _objectWithoutPropertiesLoose(props, _excluded210);
  const externalPaperSlotProps = (_slotProps$paper = slotProps == null ? void 0 : slotProps.paper) != null ? _slotProps$paper : PaperPropsProp;
  const paperRef = React76.useRef();
  ...
  const getAnchorOffset = React76.useCallback(() => {
  ...
  const getTransformOrigin = React76.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React76.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React76.useState(open);
  const setPositioningStyles = React76.useCallback(() => {
  ...
  React76.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
  ...
  } = _useSlotProps, rootProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded35);
  return (0, import_jsx_runtime56.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
var Menu3 = React77.forwardRef(function Menu4(inProps, ref) {
  ...
  const menuListActionsRef = React77.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React77.Children.map(children, (child, index2) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UEBYMJOM.js.map
